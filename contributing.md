...
1. Update the README.md with details of changes to the interface, this includes new variables, useful file locations and any other parameters.
...
reported by contacting the project team on their respective twitter profiles. All complaints will be reviewed and investigated and will result in a response that is deemed necessary and appropriate to the circumstances. The project team is obligated to maintain confidentiality with regard to the reporter of an incident. Further details of specific enforcement policies may be posted separately.
